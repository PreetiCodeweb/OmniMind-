...
const MEMORY_DATA = [
  { id: 1, type: 'Goal', title: 'Become an AI Entrepreneur', body: 'Build and ship OmniMind as a SaaS platform by Q3 2025.', date: '2d ago', tag: 'Career', tagColor: 'badge-blue', accent: '#4d9cff' },
  { id: 2, type: 'Project', title: 'OmniMind Frontend Build', body: 'React + FastAPI stack. LobeHub-inspired dark UI with multi-model routing.', date: '1d ago', tag: 'Active', tagColor: 'badge-green', accent: '#34d399' },
...
const CHAT_HISTORY = [
  { id: 1, role: 'ai', model: 'Claude', modelColor: '#34d399', text: 'Good morning! I have your OmniMind project context loaded. You were working on the Knowledge Graph engine — specifically the embedding layer for cross-model memory retrieval. Want to continue?', time: '9:02 AM' },
...
const NOTIFICATIONS = [
  { id: 1, type: 'success', message: 'Memory saved successfully', icon: '✓', time: 'now' },
  { id: 2, type: 'warning', message: 'Storage at 85% capacity', icon: '⚠', time: '2h ago' },
  { id: 3, type: 'info', message: 'New model available: Claude 4', icon: 'ℹ', time: '1d ago' },
];

// Activity Timeline
const ACTIVITY_TIMELINE = [
  { id: 1, action: 'Created', object: 'RAG Pipeline Goal', timestamp: '2 hours ago', status: 'completed' },
  { id: 2, action: 'Updated', object: 'Memory Vault', timestamp: '5 hours ago', status: 'completed' },
  { id: 3, action: 'Shared', object: 'Knowledge Graph', timestamp: 'Yesterday', status: 'pending' },
];
...
const MENU_ITEMS = [
  ...
  { id: 'chat', icon: '◇', label: 'Chat', badge: { count: 3, color: 'blue' } },
  { id: 'passport', icon: '◈', label: 'AI Passport', badge: null },
  { id: 'vault', icon: '◻', label: 'Memory Vault', badge: { count: 47, color: 'none' } },
...
const ONBOARDING_STEPS = [
  { step: 1, title: 'Welcome to OmniMind', description: 'Your AI memory layer', image: '🧠' },
  { step: 2, title: 'Connect Models', description: 'Add Claude, GPT, Gemini', image: '🔌' },
  { step: 3, title: 'Create Memories', description: 'Store knowledge from conversations', image: '💾' },
  { step: 4, title: 'Build Graphs', description: 'Connect related ideas and concepts', image: '🔗' },
];

// Settings Configuration
const SETTINGS_CONFIG = {
  passport: [
    { key: 'name', label: 'Name', value: 'Preeti', type: 'text' },
    { key: 'role', label: 'Role', value: 'AI Entrepreneur · Engineer', type: 'text' },
  ],
  privacy: [
    { key: 'encryption', label: 'E2E Encryption', value: true, type: 'toggle' },
    { key: 'analytics', label: 'Share Analytics', value: false, type: 'toggle' },
  ],
};

// Error Messages & Help Text
const ERROR_MESSAGES = {
  MEMORY_FULL: 'Your memory vault is at capacity. Upgrade to Pro.',
  MODEL_OFFLINE: 'Claude is currently offline. Try another model.',
  SYNC_FAILED: 'Memory sync failed. Retrying...',
};

// Empty States
const EMPTY_STATES = {
  noChat: { icon: '💬', title: 'No conversations yet', message: 'Start a new chat to begin' },
  noMemory: { icon: '📝', title: 'Memory vault is empty', message: 'Create your first memory' },
  noGraph: { icon: '🔗', title: 'No knowledge graph yet', message: 'Add memories to build your graph' },
};
